 ...
 */
@TableName("lipin")
public class LipinEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Lipin{" +
            "id=" + id +
            ", lipinName=" + lipinName +
            ", lipinDanwei=" + lipinDanwei +
            ", lipinPhoto=" + lipinPhoto +
            ", suoxuNumber=" + suoxuNumber +
            ", lipinDelete=" + lipinDelete +
            ", lipinContent=" + lipinContent +
