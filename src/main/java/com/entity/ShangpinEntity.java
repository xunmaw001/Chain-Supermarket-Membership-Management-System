...
public class ShangpinEntity<T> implements Serializable {
     ...
     * 商店
     */
    @TableField(value = "shangdian_id")

    private Integer shangdianId;
    ...
    public void setShangdianId(Integer shangdianId) {
        this.shangdianId = shangdianId;
    }
    /**
	 * 设置：商品名称
	 */
