<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='lipin'">
                    <el-form-item class="select" v-if="type!='info'"  label="礼品" prop="lipinId">
                        <el-select v-model="ruleForm.lipinId" :disabled="ro.lipinId" filterable placeholder="请选择礼品" @change="lipinChange">
                            <el-option
                                    v-for="(item,index) in lipinOptions"
                                    v-bind:key="item.id"
                                    :label="item.lipinName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='lipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="礼品名称" prop="lipinName">
                        <el-input v-model="lipinForm.lipinName"
                                  placeholder="礼品名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="礼品名称" prop="lipinName">
                            <el-input v-model="ruleForm.lipinName"
                                      placeholder="礼品名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='lipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="单位" prop="lipinDanwei">
                        <el-input v-model="lipinForm.lipinDanwei"
                                  placeholder="单位" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="单位" prop="lipinDanwei">
                            <el-input v-model="ruleForm.lipinDanwei"
                                      placeholder="单位" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='lipin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.lipinPhoto" label="礼品照片" prop="lipinPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (lipinForm.lipinPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lipinPhoto" label="礼品照片" prop="lipinPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.lipinPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='lipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所需积分" prop="suoxuNumber">
                        <el-input v-model="lipinForm.suoxuNumber"
                                  placeholder="所需积分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="所需积分" prop="suoxuNumber">
                            <el-input v-model="ruleForm.suoxuNumber"
                                      placeholder="所需积分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="lipinId" name="lipinId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="lipinduihuanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.lipinduihuanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lipinduihuanContent" label="备注" prop="lipinduihuanContent">
                            <span v-html="ruleForm.lipinduihuanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
             url: `lipin/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.lipinOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.lipinChange(data.data.lipinId)
