    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="消费流水号" prop="xiaofeiUuidNumber">
                       <el-input v-model="ruleForm.xiaofeiUuidNumber"
                                 placeholder="消费流水号" clearable  :readonly="ro.xiaofeiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="消费流水号" prop="xiaofeiUuidNumber">
                           <el-input v-model="ruleForm.xiaofeiUuidNumber"
                                     placeholder="消费流水号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            <input id="shangpinId" name="shangpinId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="消费数量" prop="xiaofeiNumber">
                       <el-input v-model="ruleForm.xiaofeiNumber"
                                 placeholder="消费数量" clearable  :readonly="ro.xiaofeiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="消费数量" prop="xiaofeiNumber">
                           <el-input v-model="ruleForm.xiaofeiNumber"
                                     placeholder="消费数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="xiaofeiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xiaofeiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaofeiContent" label="备注" prop="xiaofeiContent">
                            <span v-html="ruleForm.xiaofeiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="消费时间" prop="xiaofeiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xiaofeiTime"
                                type="datetime"
                                placeholder="消费时间"
                                :disabled="ro.xiaofeiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaofeiTime" label="消费时间" prop="xiaofeiTime">
                            <span v-html="ruleForm.xiaofeiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                yuangongForm: {},
                ro:{
                    xiaofeiUuidNumber: false,
                    yuangongId: false,
                    yonghuId: false,
                    shangpinId: false,
                    xiaofeiNumber: false,
                    xiaofeiContent: false,
                    xiaofeiTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    xiaofeiUuidNumber: new Date().getTime(),
                    yuangongId: '',
                    yonghuId: '',
                    shangpinId: '',
                    xiaofeiNumber: '',
                ...
                rules: {
                   xiaofeiUuidNumber: [
                              { required: true, message: '消费流水号不能为空', trigger: 'blur' },
                          ],
                   yuangongId: [
                   ...
                   xiaofeiNumber: [
                              { required: true, message: '消费数量不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xiaofei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xiaofeiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
