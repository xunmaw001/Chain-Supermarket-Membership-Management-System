    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="积分类型" prop="jifenTypes">
                        <el-select v-model="ruleForm.jifenTypes" :disabled="ro.jifenTypes" placeholder="请选择积分类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="积分类型" prop="jifenValue">
                        <el-input v-model="ruleForm.jifenValue"
                            placeholder="积分类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="数量" prop="jifenNumber">
                       <el-input v-model="ruleForm.jifenNumber"
                                 placeholder="数量" clearable  :readonly="ro.jifenNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="数量" prop="jifenNumber">
                           <el-input v-model="ruleForm.jifenNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="jifenContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jifenContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jifenContent" label="详情" prop="jifenContent">
                            <span v-html="ruleForm.jifenContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
