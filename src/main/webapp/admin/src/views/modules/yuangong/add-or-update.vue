<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shangdian'">
                    <el-form-item class="select" v-if="type!='info'"  label="商店" prop="shangdianId">
                        <el-select v-model="ruleForm.shangdianId" :disabled="ro.shangdianId" filterable placeholder="请选择商店" @change="shangdianChange">
                            <el-option
                                    v-for="(item,index) in shangdianOptions"
                                    v-bind:key="item.id"
                                    :label="item.shangdianName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangdian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商店名称" prop="shangdianName">
                        <el-input v-model="shangdianForm.shangdianName"
                                  placeholder="商店名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商店名称" prop="shangdianName">
                            <el-input v-model="ruleForm.shangdianName"
                                      placeholder="商店名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shangdian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商店地址" prop="shangdianAddress">
                        <el-input v-model="shangdianForm.shangdianAddress"
                                  placeholder="商店地址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商店地址" prop="shangdianAddress">
                            <el-input v-model="ruleForm.shangdianAddress"
                                      placeholder="商店地址" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <input id="updateId" name="id" type="hidden">
            <input id="shangdianId" name="shangdianId" type="hidden">
               <el-col :span="12">
...
<script>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
             url: `shangdian/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.shangdianOptions = data.data.list;
            }
         });
        ...
        methods: {
            ...
            shangdianChange(id){
                this.$http({
                    url: `shangdian/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangdianForm = data.data;
                    }
                });
            },
            // 多级联动参数
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.shangdianChange(data.data.shangdianId)
                    } else {
