  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'" label='商店名称' prop="shangdianName">
                 <el-input v-model="ruleForm.shangdianName" :disabled="true" placeholder="商店名称"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'" label='商店地址' prop="shangdianAddress">
                 <el-input v-model="ruleForm.shangdianAddress" :disabled="true" placeholder="商店地址"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.shangdianId)&& 'yuangong'==this.flag){
