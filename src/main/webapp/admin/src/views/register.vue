<template>
    <div style="backgroundImage: url('/huiyuanguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">连锁超市会员管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                       ...
                       <!--<el-form-item class="select" label="商店">
                            <el-select style="width: 300px" v-model="ruleForm.shangdianId" placeholder="请选择商店">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 员工 的 商店
                            // if((!this.ruleForm.shangdianId)&& 'yuangong'==this.tableName){
                            //     this.$message.error('商店不能为空');
                            //     return
                            // }
